 ...
 * Token refresh handling has been added with single-flight guard.
...
// Token refresh endpoint path. Used to detect when we're already trying
// to refresh to avoid infinite retry loops.
const REFRESH_ENDPOINT = '/auth/refresh';

// In-memory storage for the refresh promise to deduplicate concurrent refresh attempts.
